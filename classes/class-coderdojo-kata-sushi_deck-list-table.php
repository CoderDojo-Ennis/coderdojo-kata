...
if ( ! class_exists( 'Project_List_Table' ) ) {
	...
	class Sushi_Deck_List_Table extends WP_List_Table {
		...
		function prepare_items() {
			...
			{
				$card = array('ID' => $project_object->ID,'post_title' => $project_object->post_title, 'post_parent' => $project_object->post_parent, 'order' => $project_object->menu_order, 'post_status' => $project_object->post_status);
